...
def tournament_selection(population: list[Solution], maximization: bool): #30 to 40 % moderated pressure
    ...
    for _ in range(population_size):
        ...
        tournament_participants = np.random.choice(population, size=k, replace=False) #without replacement, we can change k and with replacement
